...
public class MinimumPropertyParser<T extends DataTypeDescription> implements PropertyParser<T> {
    ...
    public void parsePropertyToDescription(@NonNull T description,
        ...
        if (property.isIntegralNumber() || property.isFloatingPointNumber() || property.isTextual()) {
            description.setMinimum(new StringAtomicProperty(property.asText()));
