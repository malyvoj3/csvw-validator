...
public class MinInclusivePropertyParser<T extends DataTypeDescription> implements PropertyParser<T> {
    ...
    public void parsePropertyToDescription(@NonNull T description,
        ...
        if (property.isIntegralNumber() || property.isFloatingPointNumber() || property.isTextual()) {
            description.setMinInclusive(new StringAtomicProperty(property.asText()));
