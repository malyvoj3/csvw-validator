...
//    public Table createAnnotations(Table extractedTable, TableGroupDescription tableGroupDescription) {
...
//        return createAnnotations(extractedTable, tableDescription);
//    }

    public Table createAnnotations(Table extractedTable, TableDescription tableDescription) {
        String baseLanguage = Optional.ofNullable(tableDescription.getContext())
        ...
        InheritedProperties defaultProperties = mergeInheritedProperties(
                createInheritedProperties(tableDescription.getTableSchema().getValue()),
